...
var Canvas = function () {
  ...
  _createClass(Canvas, [{
    ...
    value: function resize() {
      this.canvas.width = (0, _jquery2.default)(this.canvas.element).parent()[0].offsetWidth;
      this.canvas.height = (0, _jquery2.default)(this.canvas.element).parent()[0].offsetHeight;
    ...
    value: function convertCanvasCoordinatesToFeatures(x, y) {
      var f1 = (x - (0, _jquery2.default)(this.canvas.element).position().left) / this.canvas.width;
      var f2 = (y - (0, _jquery2.default)(this.canvas.element).position().top) / this.canvas.height;
